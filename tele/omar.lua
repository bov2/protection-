...
send(data.chat_id,data.id,"✪ اهلا بك في صانع حسابات تيليثون سورس القرش \n✪ مطور البوت @T_3_A","html",true, false, false, true, reply_markup)
return false 
end
