...
async def shark1(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊](https://t.me/L_H_V) ⧽=====✪
: ⦑   قائمة اوامر الخاص في سورس القرش  ⦒
✪ تفعيل ، تعطيل الترحيب 
✪ قبول ، رفض
✪ كتم ، الغاء كتم 
✪ سبام + الكلمه + الرقم (سبام القرش 22)
✪ ايدي + ايدي بالرد
✪ انتحال ● رجوع
✪=====⧼ [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊](https://t.me/L_H_V) ⧽=====✪
""",
...
async def shark2(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊](https://t.me/L_H_V) ⧽=====✪
: ⦑   قائمة اوامر الجروبات في سورس القرش  ⦒
✪ حظر ، الغاء حظر
✪ مسح المحظورين
✪ كتم ، الغاء كتم 
✪ مسح المكتومين
...
async def shark3(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊](https://t.me/L_H_V) ⧽=====✪
: ⦑   قائمة اوامر اليوتيوب في سورس القرش  ⦒
✪ غ + اسم الاغنيه
✪ ف + اسم الفيديو
✪=====⧼ [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊](https://t.me/L_H_V) ⧽=====✪
""",
...
async def shark4(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊](https://t.me/L_H_V) ⧽=====✪
: ⦑   قائمة اوامر الاذاعه في سورس القرش  ⦒
...
async def shark5(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊](https://t.me/L_H_V) ⧽=====✪
: ⦑   قائمة اوامر الرفع في سورس القرش  ⦒
...
async def shark6(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊](https://t.me/L_H_V) ⧽=====✪
: ⦑   قائمة الاوامر الاضافيه في سورس القرش  ⦒
...
async def shark7(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊](https://t.me/L_H_V) ⧽=====✪
: ⦑   قائمة اوامر التسليه في سورس القرش  ⦒
✪ `.مكعبات`
✪ `.قمر`
✪ `.قلوب`
✪ `.قلب`
...
async def shark8(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊](https://t.me/L_H_V) ⧽=====✪
: ⦑   قائمة اوامر التسليه 2 في سورس القرش  ⦒
✪ `.غبي`
✪ `.تفجير`
✪ `.طوبه`
✪ `.مربعات`
...
async def shark9(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊](https://t.me/L_H_V) ⧽=====✪
: ⦑   قائمة اوامر التسليه 3 في سورس القرش  ⦒
✪ `.رموز شيطانيه`
✪ `.اسعاف`
✪ `شرطه`
✪ `.زعلت`
...
✪ `.عبقري`
✪ `.قتل`
✪ انتظرو تحديثات عظمه ل تليثون سورس القرش 🔥
✪=====⧼ [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊](https://t.me/L_H_V) ⧽=====✪
""",
    ]
    for i in animation_ttl:
...
async def shark10(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊](https://t.me/L_H_V) ⧽=====✪
: ⦑   قائمة اوامر الالعاب في سورس القرش  ⦒
 ✪ `.اكس او` 
...
async def shark11(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊](https://t.me/L_H_V) ⧽=====✪
: ⦑   قائمة اوامر الالعاب المتطوره في سورس القرش  ⦒
 ✪ `.القط المجنون` 
✪ `.ركل الكره`
✪ `.السمك الشائك`
✪ `.كرة السله`
...
async def shark12(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊](https://t.me/L_H_V) ⧽=====✪
: ⦑   قائمة اوامر الميمز في سورس القرش  ⦒
✪ `.هنضحك`
✪ `.مينفعش`
...
async def shark13(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊](https://t.me/L_H_V) ⧽=====✪
: ⦑   قائمة اوامر الميمز 2 في سورس القرش  ⦒
✪ `.في رمضان`
✪ `.مش عارف اقوم`
✪ `.دمك خفيف اوي`
...
async def shark14(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊](https://t.me/L_H_V) ⧽=====✪
: ⦑   قائمة اوامر الميمز 3 في سورس القرش  ⦒
✪ `.تاخد نفس عميق`
✪ `.ربنا نصرني`
✪ `.لو معايا خنجرين`
✪ `.اماااال`
...
async def shark15(c, msg):
    ...
    animation_chars = [
        """
✪=====⧼  [𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊](https://t.me/L_H_V) ⧽=====✪
: ⦑   قائمة اوامر النسب في سورس القرش  ⦒
✪ `.نسبة الانوثة`
✪ `.نسبة الغباء`
✪ `.نسبة الرجولة`
✪ `.نسبة المنيكه`
